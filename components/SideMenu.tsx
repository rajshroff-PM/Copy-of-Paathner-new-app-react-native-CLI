...
import { Map as MapIcon, Calendar, FileText, CreditCard, LifeBuoy, Car, Route, Flame, ChevronRight } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-6 border-t border-gray-200/50 dark:border-white/5 bg-white/30 dark:bg-black/20 backdrop-blur-md z-10 text-center">
           <span className="text-[10px] text-gray-400 dark:text-gray-500 font-mono">v2.23.3</span>
        </div>
      </div>
    </>
  );
